...
QT_MOC_LITERAL(1, 7, 20), // "removeSelectableItem"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 14), // "QGraphicsItem*"
QT_MOC_LITERAL(4, 44, 10) // "removeItem"

    },
    "Viewer\0removeSelectableItem\0\0"
    "QGraphicsItem*\0removeItem"
};
...
void Viewer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->removeSelectableItem((*reinterpret_cast< QGraphicsItem*(*)>(_a[1]))); break;
        case 1: _t->removeItem((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Viewer::*_t)(QGraphicsItem * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Viewer::removeSelectableItem)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void Viewer::removeSelectableItem(QGraphicsItem * _t1)
{
